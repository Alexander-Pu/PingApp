...
//        LatLng coordinates;
//        if (mLastLocation == null) {
//            coordinates = new LatLng(-34, 151);
//            System.out.println("location is null");
//
//        }
//        else {
//            coordinates = new LatLng(mLastLocation.getLatitude(), mLastLocation.getLongitude());
//            System.out.println("Latitude: " + mLastLocation.getLatitude());
//            System.out.println("Longitude " + mLastLocation.getLongitude());
//        }
//        mMap.addMarker(new MarkerOptions().position(coordinates).title("Marker in Location"));
